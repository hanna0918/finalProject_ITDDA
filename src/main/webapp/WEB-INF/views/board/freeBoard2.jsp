...
<body>
   <div id='qNaContainer'>
      ...
      <c:forEach var="vo" items="${list}">
         <div class='list'>
            <ul class='content'>
               ...
               <div class="dropdown">
                  <li><label onclick="myFunction('${vo.m_nickname}');"
                     class="dropbtn" id="droplogin">${vo.m_nickname} <input
                        type="hidden" class="idtest" value="${vo.m_seq}" /></label></li> <input
                     type="hidden" value="${vo.m_name}" />
      ...
      <!-- 글쓰기 버튼 -->
      <div>
         <a href="/itda/freeboardWrite"><input type='submit' value='글쓰기'
            id='writeBtn' /></a>
      </div>
      <!-- 페이지번호 -->
      <div id='page'>
