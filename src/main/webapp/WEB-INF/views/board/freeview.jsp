...
/*북마크 해제 모달창*/
/*모달창*/
   .bookJoinModal2, .delJoinModal2, .delJoinModal3 {
     display: none;
     position: fixed;
     top: 0;
     left: 0;
   ...
   .bookModalContent2, .bookModalContent3 {
     position: relative;
     margin: 0 auto;
     width: 400px;
     padding: 20px;
   ...
   .delModalContent2, .delModalContent3{
	position: relative;
    margin: 230px auto;
    width: 320px;
    padding: 20px;
   ...
   .delDataInputModal2, .delDataInputModal3{
         ...
         <div class="freeBoardUser">
            <div class="freeUserinfo">
               ...
               <c:if test="${vo.m_seq==logseq}">
                  ...
                  <a class="delBoard" name="board_seq" style="color:black;">삭제</a>
                  </div>
               </c:if>
  ...
  <!--  
   신고모달, alert 대용 모달
    <div class="matchingReportModal" id="matchingReportModal">
		...
		<!-- 글 삭제하시겠습니까 모달-->
			<div class="delJoinModal2" id="delJoinModal2">
				<article class="delModalContent2 delDataInputModal2">
					<div>
						<label style="font-size: 1.5em;">정말 삭제하시겠습니까?</label>
				         <div> <input type="button" id="delBoardYes" name="board_seq"value="확인"/>
				         <input type="button" id="delBoardNo" value="취소"/></div>
					</div>
				</article>
			</div> 
			...
			<!-- 글 삭제했을 때 확인 모달-->
			<div class="delJoinModal3" id="delJoinModal3">
				<article class="delModalContent3 delDataInputModal3">
					<div>
						<label style="font-size: 1.5em;">게시글이 삭제되었습니다!</label>
				         <div><input type="button" id="delBoardOk" name="board_seq"value="확인"/></div> 
					</div>
				</article>
			</div> 
   ...
   /*$(function(){
      ...
      /*글 삭제 모달*/
	    $(".delBoard").click(function(){
	    	$('.delDataInputModal2').css('display', 'block');
	         $('.delJoinModal2').css('display', 'block');
	         
	         /*취소버튼 눌렀을 때 */
	         $("#delBoardNo").click(function(){
	        	 $('.delJoinModal2').css('display', 'none');  
	         });
	    });
	         
	         $("#delBoardYes").click(function(){
	        	 $('.delJoinModal2').css('display', 'none');  
	         	 $('.delDataInputModal3').css('display', 'block');
		         $('.delJoinModal3').css('display', 'block');
		     	
	         $("#delBoardOk").click(function(){
	        	 $('.delJoinModal3').css('display', 'none');  
	        	 location.href="/itda/freeDelete?board_seq=${vo.board_seq}";
	         });
