...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	<link rel="stylesheet" href="/itda/css/injeungWrite.css?version=1">
    ...
    <section id="injeungWriteFrame">
    <h2>인증게시판</h2>
    <h4>나의 활동을 인증해보자!</h4>
        <form method="post" action="#">
        <div id="injeungBasicInfoArea">
                <div>
                    <ul id="titleAndMap">
                        <li><input type="text" id="injeungWriteTitle" name="injeungWriteTitle" placeholder="제목을 입력하세요" /></li>
        ...
        <div id="injeungBtnDiv">
            <input type="submit" value="등록" id="injeungSubmitBtn" />
            <input type="submit" value="취소" id="injeungCancelBtn" />
        </div>
    ...
    <script src="/itda/js/injeungWrite.js?version=1"></script>