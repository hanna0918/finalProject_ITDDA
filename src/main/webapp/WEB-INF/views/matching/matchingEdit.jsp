...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            ...
            <form method="post" id="matchingUploadForm" onsubmit="return false">
                <div>
                    <ul id="titleAndMap">
                        ...
                        <li>매칭 시작일</li>
                        <li><input type="date" name="startDate" id='startDate' value='${vo.startDate}' required/></li>
                        <li>매칭 시간</li>
                        <li><input type="time" name="startTime" id='startTime' value='${vo.startTime}' required/></li>
                        <li>~</li>
                        <li><input type="time" name="endTime" id='endTime' value='${vo.endTime}' required/></li>
                        <li><input type="number" name="mc_max" id="mc_max" placeholder="매칭 최대 인원 (최대 10인)" min="2" max="10" value='${vo.mc_max}' required/></li>
    ...
    <script src="/itda/js/matchingEdit.js?version=1111111111111111111"></script>