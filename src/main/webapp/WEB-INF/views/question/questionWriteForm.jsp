...
@import url('https://cdn.jsdelivr.net/gh/projectnoonnu/noonfonts_20-07@1.0/IBMPlexSansKR-Regular.woff') format('woff');
	...
	.questionWriteHeaderLine{
		margin:0 auto;
	}
	.questionWriteHeaderLine>div:first-child{
		font-size:2em;
		float: left;
    	width:5%;
    	color: #4a4a4a;
	...
	.questionWriteHeaderLine>div:last-child{
		width:80%;
		float: left;
		font-size:1.1em;
		color:gray;
	...
	.questionWriteHeaderLine input[type="submit"]{
		float:right;
	}
	...
	#questionboardTitleWrap>div:nth-child(1){
	    border-bottom: 1px solid rgba(128, 128, 128, 0.3);
    	/* position: relative; */
        vertical-align: middle;
        display: table-cell;
	...
	#questionboardTitleWrap>div:nth-child(2){
		padding-left: 20px;
		vertical-align: middle;
        display: table-cell;
        font-size:20px
	...
	<div class="questionboardWrite">
		<div class="questionWriteHeader"> 
			<div class="questionWriteHeaderLine">
				<div>Q&A</div><div>궁금한건 못참지! 궁금함을 공유해보세요!</div>
				<!-- <div>
