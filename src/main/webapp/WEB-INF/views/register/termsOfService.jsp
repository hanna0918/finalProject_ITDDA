...
<div class="termsOfService" id="termsOfService">
  <div class="modalOverlay"></div>
  <article class="termsOfServiceFrame">
    <div>이용약관</div>
    <div id="tosCloseBtn" class="closeBtn">╳</div>
    <div id="tosContent">
    <p>
	제1조 목적<br/>
	<br/>
	본 이용약관은 “디그디그 액티비티”(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.<br/><br/>
	...
	① 회원으로 등록하여 사이트를 이용하려는 이용자는 사이트에서 요청하는 제반정보(이용자ID, 비밀번호, 이름, 이메일, 핸드폰 번호)를 제공해야 합니다.<br/>
