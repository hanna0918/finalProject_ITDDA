...
$(function(){
            ...
            success: function(result){
				...
				result.each(function(idx, vo){
					...
					if(vo.m_seq == m_seq){ // 자신이 쓴 댓글일때
						...
						tag += "<textarea name='br_content' id='br_content'>" + vo.br_content + "</textarea>";
	...
	$(document).on('click','.deleteReply',function(){
        ...
        tag += "<input type='button' class='close' value='취소'></input>";
        $(".matchingReportModalContent").html(tag);
		$('.matchingReportModal').css('display', 'block');
	});
